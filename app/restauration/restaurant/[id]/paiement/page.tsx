...
export default function RestaurantPaiementPage() {
  ...
  async function handleConfirmScan() {
    ...
    router.push(
      `/restauration/restaurant/${restaurantId}/recu?${receiptParams.toString()}`,
    );
  }
    ...
    <main className="mx-auto w-full max-w-5xl space-y-6 px-6 py-8 lg:px-10">
      ...
      <section className="space-y-4 rounded-3xl bg-sky-500 p-6 text-white">
        <div className="space-y-1">
          <p className="text-4xl font-extrabold">Paiement restaurant</p>
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() =>
              router.push(`/restauration/restaurant/${restaurantId}`)
            }
